...
class Customer(db.Model, SerializerMixin):
    ...
    # Association proxy to get items for this customer though reviews
...
class Review(db.Model, SerializerMixin):
    ...
    # Relationship mapping the assignment to related customer
    customer = db.relationship('Customer', back_populates='reviews')
    # Relationship mapping the assignment to related item
